...
public:
    ...
    Result add_block(std::shared_ptr<Chunk> &chunk, const BlockType type, const vec3 location, const bool overwrite);
    ...
    void plant_tree(std::shared_ptr<Chunk> &chunk, const vec3 location) const;
    void update_mesh();
