...
void renderFrame(const gameState &state, const xObjects &xObjs, const std::optional<xObjects> &imObjs, const glObjects &glObjs, Camera &camera, Mvp &mvp, const size_t indicesSize);
